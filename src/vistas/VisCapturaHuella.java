...
public class VisCapturaHuella extends javax.swing.JFrame {

    /** Creates new form CapturaHuella */
    
    String cedPersona;
    public VisCapturaHuella(String cedPersona) {
...
public  void ProcesarCaptura(DPFPSample sample)
 ...
 if (featuresinscripcion != null)
	...
	switch(Reclutador.getTemplateStatus())
	    ...
	    EstadoHuellas();
	    setTemplate(null);
	    JOptionPane.showMessageDialog(VisCapturaHuella.this, "La Plantilla de la Huella no pudo ser creada, Repita el Proceso", "Inscripcion de Huellas Dactilares", JOptionPane.ERROR_MESSAGE);
	    start();
	    break;
	}
	     }
  ...
  */
    public void guardarHuella(){
     ...
     Connection c=con.getConexion(); //establece la conexion con la BD
      ...
      PreparedStatement updatePersonal = c.prepareStatement("UPDATE persona set huella_per=? WHERE ced_per=?");
        //updatePersonal.setBinaryStream(1, datosHuella,tamañoHuella);
        updatePersonal.setBinaryStream(1, datosHuella,tamañoHuella);
        updatePersonal.setString(2,cedPersona);
...
*/
 public void verificarHuella(String nom) {
    ...
    PreparedStatement verificarStmt = c.prepareStatement("SELECT huella_per FROM persona WHERE id_per=?");
  ...
  */
  public void identificarHuella() throws IOException{
     try {
       ...
       PreparedStatement identificarStmt = c.prepareStatement("SELECT nom_per,huella_per FROM persona");
       ResultSet rs = identificarStmt.executeQuery();

       //Si se encuentra el nombre en la base de datos
       while(rs.next()){
       //Lee la plantilla de la base de datos
       byte templateBuffer[] = rs.getBytes("huella_per");
