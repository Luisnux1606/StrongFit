...
public class JButtonTableExample {
    ...
    public JButtonTableExample(VisBuscarVentas visVentas) {
...
*/
        ...
        visVentas.tblFacturaDetalles.getColumn("Button").setCellRenderer(new ButtonRenderer());
        visVentas.tblFacturaDetalles.getColumn("Button").setCellEditor(new ButtonEditor(new JCheckBox()));
